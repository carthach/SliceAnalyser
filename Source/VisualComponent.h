/*
  ==============================================================================
    ...
    VisualComponent.h
    Created: 4 Jun 2015 12:14:52pm
    Author:  Cárthach Ó Nuanáin

  ==============================================================================
*/

#ifndef VISUALCOMPONENT_H_INCLUDED
#define VISUALCOMPONENT_H_INCLUDED
...
public:
    ...
    testsListModel (testsList)
    {
        ...
        testsListBox.selectRow (visualWorld);
...
private:
    ...
    static Test* createTest (int index)
    {
        switch (index)
        {
            ...
            case visualWorld:   return new VisualWorld();
            default:            break;
        }
...
#endif  // VISUALCOMPONENT_H_INCLUDED
